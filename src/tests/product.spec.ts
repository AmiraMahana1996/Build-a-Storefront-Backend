    ...
    it('test create method', async () => {
        UserService.register({
            ...
            expect(result).toEqual({
                ...
                "firstname": "amira                                                                                                                                                                                                                                                          ",
                "lastname": "ali                                                                                                                                                                                                                                                            ",
                "password": "$argon2id$v=19$m=64000,t=3,p=1$MHqH9AWW7ZngVIvMjZHAoQ$PVX/37nGZwmTu+vY4PPUjLTsXJ6mlVKxlskX/SitCkc                                                                                                                                                              ",
                "email": "ali@gmail.com                                                                                                                                                                                                                                                  "
            })
        })
    });
    it('test login method', async () => {
        UserService.login("sara@gmail.com", "123").then((result) => {
            expect(result).toEqual({
                "id": 3,
                "firstname": "amira                                                                                                                                                                                                                                                          ",
                "lastname": "ali                                                                                                                                                                                                                                                            ",
